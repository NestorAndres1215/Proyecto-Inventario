...
public class UsuarioOperadorServicePDF {
	...
	public byte[] generarInformePdf() throws DocumentException {
		List<Usuario> usuariosActivos = usuarioService.listarUsuarioNormalActivado();
		return PdfReportGenerator.generar("Informe de Usuario Operador", HEADERS, COLUMN_WIDTHS, usuariosActivos, EXTRACTORES);
	}
}